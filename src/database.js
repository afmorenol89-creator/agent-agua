...
function obtenerEstadisticas() {
  ...
  return {
    hoy: {
      reportaron: new Set(revisionesHoy.map(r => r.trabajador_numero)).size,
      completaron: revisionesHoy.filter(r => r.completado).length,
    },
  };
}

module.exports = {
  registrarRevision, marcarConMultimedia, obtenerRevisionesHoy,
  obtenerHistorial, registrarRecordatorio, marcarRecordatorioRespondido,
  obtenerRecordatoriosSinRespuesta, marcarAlertaEnviada, guardarMultimedia,
  obtenerEstadisticas,
};
